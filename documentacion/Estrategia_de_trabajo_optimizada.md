...
**Nota**: Esta estrategia proporciona un flujo de trabajo **coherente, reproducible y eficiente** que maximiza la productividad en el desarrollo de la tesis Edge AI, manteniendo el enfoque en los objetivos de investigación mientras se asegura la calidad y la preparación para deployment en entornos edge.
